...
public class ScissorsModel<T extends LivingEntity> extends HumanoidModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION =
			new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ScissorsBaptism.MOD_ID, "scissors"), "main");
	...
	public ScissorsModel(ModelPart root) {
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int i, int i1, int i2) {
		...
		RightArm.render(poseStack, vertexConsumer, i, i1, i2);
		LeftArm.render(poseStack, vertexConsumer, i, i1, i2);
